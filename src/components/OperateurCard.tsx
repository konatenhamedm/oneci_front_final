    ...
    <div
      ...
      className={`flex items-center p-3 h-[10em] w-[30em]   ${
        type == "orange"
          ...
          ? "bg-[#0063ad]"
          : "bg-[#1dc4ff]"
      } rounded-3xl shadow-lg  cursor-pointer group hover:bg-[#f1a730] hover:to-[#95ebdb] transition ease-in-out duration-150`}
    >
      <section className="flex justify-center items-center w-14 h-14 rounded-lg shadow-md bg-gradient-to-r from-[#F9C97C] to-[#A2E9C1] hover:from-[#C9A9E9] hover:to-[#7EE7FC] hover:cursor-pointer hover:scale-110 duration-300">
        ...
        <Image
          ...
          src={`/${image}.png`}
          alt="logo"
          className="w-10 h-10 fill-gray-700"
        />
      </section>
      ...
      <section className="block border-l border-gray-300 m-3">
        <div className="pl-3">
          ...
          <h1 className="z-20 font-bold font-Poppin text-[1.4em] text-white group-hover:text-white duration-100">
            {title}
          </h1>
        </div>
